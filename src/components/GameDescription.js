    ...
    return(
      <Modal open={this.props.showGameDescription}>
        <Grid stackable>
          <Grid.Row>
            <Grid.Column>
              <Segment padded="very">
                ...
                <p>Help him to get new skills and find all the bugs in the given level.</p>
          ...
          <Grid.Row>
            <Grid.Column>
              <Button positive floated="right" content="Let's start the journey!" onClick={this.props.onClick} />
            </Grid.Column>
          </Grid.Row>
        </Grid>  
      </Modal>
