...
import { Header, Divider, Icon, Modal, Grid, Button, Image } from 'semantic-ui-react';
            ...
            <Grid.Column>
              ...
              an awesome web developer.</p>
                ...
                <Grid.Column mobile={16} tablet={6} computer={4} largeScreen={4} widescreen={4}>
                  <Image src="./images/hero.png" alt="player in labyrinth" centered />
                </Grid.Column>
                <Grid.Column mobile={16} tablet={6} computer={6} largeScreen={6} widescreen={6}>
                  <Image src='./images/controlpanel.png' alt='game control panel' centered />
                </Grid.Column>
